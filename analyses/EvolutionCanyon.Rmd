...
layout(matrix(c(5, 5, 1:4), 3, 2, byrow=T), heights=c(1, rep(4, 2)))
...
for (p in 1:length(dbRDA.output)){
  ...
  text(x = -0.58, y = 0.4, labs[p], cex = 1.5)
}
...
legend("center", c(paste("All; ",levels(RDA$slope)[1]," Slope", sep=""),
   ...
   "green3"), pch=c(21,21,22,22), bty='n', ncol=4, cex=0.9, pt.cex=2)  
...
# Plot Parameters
par(mfrow=c(1,1), mar=c(0.5,0.5,0,0), oma=c(5, 5, 1, 1))
layout(matrix(c(2, 1), 2, 1, byrow=T), heights=c(1, 4))
...
legend("center", c(paste("All; ",levels(RDA$slope)[1]," Slope", sep=""),
   ...
   paste("Active; ",levels(RDA$slope)[2]," Slope", sep="")),
   pt.lwd=2, col="black", pt.bg=c("wheat3", "green3", "wheat3",
   "green3"), pch=c(21,21,22,22), bty='n', ncol=4, cex=0.6, pt.cex=1)  
