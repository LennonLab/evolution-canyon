...
for(i in 1:length(cond4)){
  pair.distances4[i, 4:7] <- pair.dis(cond4[i])
}
```
...
for(i in 1:length(cond4)){
  site.distances4[i, 4:7] <- site.dis(cond4[i])
}
```
...
plot(site.distances1$all ~ site.distances1$lgp, col = "gray", pch = 16, 
     ...
     xlab = "Logseries Parameter", ylab = "Site Dissimilarity",
     main = "Condition 1")

plot(site.distances1$all ~ site.distances1$im, col = "gray", pch = 16, 
     ylim = c(0, 0.2), las = 1, cex = 0.75,
     xlab = "Logseries Parameter", ylab = "Site Distances, All (BC)",
     main = "Condition 1")
...
plot(site.distances4$all ~ site.distances4$lgp, col = "gray", pch = 16, 
     ylim = c(0, 0.2), las = 1, cex = 0.75,
     xlab = "Logseries Parameter", ylab = "Site Dissimilarity")

plot(site.distances4$all ~ site.distances4$im, col = "gray", pch = 16, 
     ylim = c(0, 0.2), las = 1, cex = 0.75,
     xlab = "Logseries Parameter", ylab = "Site Distances, All (BC)")

plot(site.distances4$all ~ log(site.distances4$dk), col = "gray", pch = 16, 
     ylim = c(0, 0.2), las = 1, cex = 0.75,
     xlab = "Logseries Parameter", ylab = "Site Distances, All (BC)")
